...
Because of legal reasons the pak0.pk3 file is not included. The way to use it on the server is to host the file outside the docker container and mount the file into the container. If you create a "q3a-assets" under home to old pak0.pk3 directory then you add this to your docker launch string.
